...
namespace Task01
{
    class Program
    {
        ...
        static void Task11()
        {
            string path = "D:\\GitHub\\OOP Lab\\Week01\\Tasks\\data.txt";
            if (File.Exists(path))
            {
        ...
        static void Task13()
        {
            string path = "D:\\GitHub\\OOP Lab\\Week01\\Tasks\\file.txt";
        ...
        static void Task14()
        {
            string path = "D:\\GitHub\\OOP Lab\\Week01\\Tasks\\pizza.txt";
